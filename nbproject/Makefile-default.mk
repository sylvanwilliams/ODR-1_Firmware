...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/ODR-1_Firmware_1.1.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=main.c DSPIC33E_hardware.c LCD_driver.c LCD_fonts.c UI_main.c UI_page0.c UI_page1.c UI_page2.c si5351a.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/main.o ${OBJECTDIR}/DSPIC33E_hardware.o ${OBJECTDIR}/LCD_driver.o ${OBJECTDIR}/LCD_fonts.o ${OBJECTDIR}/UI_main.o ${OBJECTDIR}/UI_page0.o ${OBJECTDIR}/UI_page1.o ${OBJECTDIR}/UI_page2.o ${OBJECTDIR}/si5351a.o
POSSIBLE_DEPFILES=${OBJECTDIR}/main.o.d ${OBJECTDIR}/DSPIC33E_hardware.o.d ${OBJECTDIR}/LCD_driver.o.d ${OBJECTDIR}/LCD_fonts.o.d ${OBJECTDIR}/UI_main.o.d ${OBJECTDIR}/UI_page0.o.d ${OBJECTDIR}/UI_page1.o.d ${OBJECTDIR}/UI_page2.o.d ${OBJECTDIR}/si5351a.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/main.o ${OBJECTDIR}/DSPIC33E_hardware.o ${OBJECTDIR}/LCD_driver.o ${OBJECTDIR}/LCD_fonts.o ${OBJECTDIR}/UI_main.o ${OBJECTDIR}/UI_page0.o ${OBJECTDIR}/UI_page1.o ${OBJECTDIR}/UI_page2.o ${OBJECTDIR}/si5351a.o

# Source Files
SOURCEFILES=main.c DSPIC33E_hardware.c LCD_driver.c LCD_fonts.c UI_main.c UI_page0.c UI_page1.c UI_page2.c si5351a.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE} ${MAKE_OPTIONS} -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/ODR-1_Firmware_1.1.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/ODR-1_Firmware_1.1.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    p33EP512MU810.gld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/ODR-1_Firmware_1.1.${IMAGE_TYPE}.${OUTPUT_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -D__DEBUG -D__MPLAB_DEBUGGER_PK3=1  -omf=elf -Wl,--defsym=__MPLAB_BUILD=1,--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_PK3=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/ODR-1_Firmware_1.1.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   p33EP512MU810.gld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -o dist/${CND_CONF}/${IMAGE_TYPE}/ODR-1_Firmware_1.1.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -mcpu=$(MP_PROCESSOR_OPTION)        -omf=elf -Wl,--defsym=__MPLAB_BUILD=1,$(MP_LINKER_FILE_OPTION),--stack=16,--check-sections,--data-init,--pack-data,--handles,--isr,--no-gc-sections,--fill-upper=0,--stackguard=16,--no-force-link,--smart-io,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem$(MP_EXTRA_LD_POST) 
	${MP_CC_DIR}\\xc16-bin2hex dist/${CND_CONF}/${IMAGE_TYPE}/ODR-1_Firmware_1.1.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} -a  -omf=elf 
